namespace Protobuild.Tests
{
    ...
    public class NuGetPortableLibraryDetectedWithRootPathDotTest : ProtobuildTest
    {
        private readonly IAssert _assert;

        public NuGetPortableLibraryDetectedWithRootPathDotTest(IAssert assert) : base(assert)
        {
            _assert = assert;
        }
