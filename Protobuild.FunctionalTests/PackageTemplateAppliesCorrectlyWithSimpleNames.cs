namespace Protobuild.Tests
{
    ...
    public class PackageTemplateAppliesCorrectlyWithSimpleNamesTest : ProtobuildTest
    {
        private readonly IAssert _assert;

        public PackageTemplateAppliesCorrectlyWithSimpleNamesTest(IAssert assert) : base(assert)
        {
            _assert = assert;
        }
        ...
        {
            this.SetupTest("PackageTemplateAppliesCorrectlyWithSimpleNames", true);
            ...
            var templateFolder = this.SetupSrcTemplateAlt();
            try
            {
                this.OtherMode(
